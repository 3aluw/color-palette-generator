...
<main>
  ...
  <section>
    ...
    <h2>Heading 2</h2>
    <h3>Heading 3</h3>
    <p>Lorem ipsum dolor sit amet, <a href="#">this is a link</a> consectetur adipiscing elit. Sed varius, velit in pretium gravida, urna risus tempor turpis, vitae tincidunt neque purus sit amet neque.</p>
  </section>
  ...
  <section>
    ...
    <div class="card">
      <h3>Card Title</h3>
      <p>This is a sample card using your generated color palette. It shows how backgrounds, borders, and text interact.</p>
    </div>
  </section>
...
@media screen and (max-width:600px) {
  ...
  .light { background: var(--light); border: 1px solid #ccc; }
  .dark { background: var(--dark); }
  .primary { background: var(--primary); }
  .secondary { background: var(--secondary); }
  .dark-accent { background: var(--dark-accent); }
  ...
  .btn-accent { background: var(--dark-accent); }
  ...
  .alert-primary { background: var(--primary); }
  .alert-secondary { background: var(--secondary); }
  .alert-dark { background: var(--dark); }
