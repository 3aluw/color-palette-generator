<template >
    <div class="basic-contaner" :style="cssVars">
                    ...
                    <div class="col-md-6">
                        <div class="bg-primary bg-vegetable d-flex flex-column justify-content-center p-5"
                            ...
                            <p class="text-white">Dolor magna ipsum elitr sea erat elitr amet ipsum stet justo dolor, amet
                                lorem
                                diam no duo sed dolore amet diam</p>
        ...
        <!-- Facts Start -->
        <div class="container-fluid bg-dark facts py-5 mb-5">
        ...
        <!-- Features Start -->
        <div class="container-fluid bg-dark feature py-5 pb-lg-0 my-5">
            ...
            <div class="container">
                <div class="row gx-5">
                        ...
                        <div class="row gx-5">
                            ...
                            <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                                ...
                                <div class="d-flex flex-column justify-content-start">
                                    ...
                                    <a class="text-white mb-2" href="#"><i
                                            class="bi bi-arrow-right text-white me-2"></i>About
                                        Us</a>
                                    <a class="text-white mb-2" href="#"><i class="bi bi-arrow-right text-white me-2"></i>Our
                                        Services</a>
                                    <a class="text-white mb-2" href="#"><i
                                            class="bi bi-arrow-right text-white me-2"></i>Meet
                                        The Team</a>
                                    <a class="text-white mb-2" href="#"><i
                                            class="bi bi-arrow-right text-white me-2"></i>Latest
                                        Blog</a>
                    ...
                    <div class="col-lg-4 col-md-6 mt-lg-n5">
                        <div
                            class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-dark-accent p-5">
